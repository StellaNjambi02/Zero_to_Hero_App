...
//       {/* Redemption Modal */}
//       {showModal && (
//         <div className="fixed inset-0 flex items-center justify-center z-50 bg-green-100 bg-opacity-50">
...
export default function RewardsPage() {
  ...
  const completeRedemption = async () => {
    ...
    try {
      // Only create the transaction, assuming redeemReward will handle the deduction
      await createTransaction(
        user.id,
        "redeemed",
        pendingAmount,
